...
import { Clock, Eye, Heart, Share2, TrendingUp, Zap, ArrowRight, Bot, Shield, Globe, Database, Cpu, Target, Users, BarChart3, Sparkles, Brain, MessageSquare, Rocket, Scale, Atom, Newspaper, Users2, Building2, Car, Gamepad2, Music, Camera, Briefcase, Heart as HeartIcon, AlertTriangle, Search, Filter, RefreshCw } from 'lucide-react'
...
const Home = () => {
  ...
  const handleInterestToggle = (interest) => {
    setSelectedInterests(prev => {
      ...
      // Otherwise, select only this interest (replace any previous selection)
        ...
        fetchInterestArticles([interest])
        return [interest]
      }
    })
  }
  ...
  // Fetch popular interests on component mount
  useEffect(() => {
    ...
    <div className="space-y-12">
      ...
      <section>
        <div className="card">
          ...
          {/* Popular Interests */}
          <div className="mb-6">
            <h3 className="text-lg font-semibold text-text-primary mb-4">Select Your Interest</h3>
            <p className="text-text-muted text-sm mb-4">Choose one interest to see personalized articles</p>
